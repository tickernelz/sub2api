...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/tickernelz/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="tickernelz/sub2api"
...
Documentation=https://github.com/tickernelz/sub2api
