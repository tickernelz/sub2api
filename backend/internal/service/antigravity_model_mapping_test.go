...
func TestAntigravityGatewayService_GetMappedModel(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:           "未知模型 - claude-opus-4-7 返回空（未在默认映射）",
