...
func TestDefaultPricingIncludesCodexAutoReview(t *testing.T) {
	...
	require.InDelta(t, 1.5e-5, got.OutputCostPerToken, 1e-12)
	require.InDelta(t, 2.5e-7, got.CacheReadInputTokenCost, 1e-12)
	require.InDelta(t, 5e-6, got.InputCostPerTokenPriority, 1e-12)
	require.InDelta(t, 3e-5, got.OutputCostPerTokenPriority, 1e-12)
	require.InDelta(t, 5e-7, got.CacheReadInputTokenCostPriority, 1e-12)
}
