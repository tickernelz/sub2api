...
func (s *GatewayService) initDebugGatewayBodyFile(path string) {
	...
	// #nosec G703 -- debug log path is an operator-controlled environment variable.
	...
	if dir := filepath.Dir(path); dir != "." {
		// #nosec G703 -- debug log directory is an operator-controlled environment variable.
	...
	// #nosec G703 -- debug log file is an operator-controlled environment variable.
