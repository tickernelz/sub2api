...
const (
	...
	// EdgeAssignedAPIKeys holds the string denoting the assigned_api_keys edge name in mutations.
	EdgeAssignedAPIKeys = "assigned_api_keys"
	...
	// AssignedAPIKeysTable is the table that holds the assigned_api_keys relation/edge. The primary key declared below.
	AssignedAPIKeysTable = "api_key_groups"
	// AssignedAPIKeysInverseTable is the table name for the APIKey entity.
	// It exists in this package in order to avoid circular dependency with the "apikey" package.
	AssignedAPIKeysInverseTable = "api_keys"
...
var (
	...
	// AssignedAPIKeysPrimaryKey and AssignedAPIKeysColumn2 are the table columns denoting the
	// primary key for the assigned_api_keys relation (M2M).
	AssignedAPIKeysPrimaryKey = []string{"api_key_id", "group_id"}
)
...
//
//	import _ "github.com/tickernelz/sub2api/ent/runtime"
var (
	Hooks        [1]ent.Hook
...
// ByAssignedAPIKeysCount orders the results by assigned_api_keys count.
func ByAssignedAPIKeysCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newAssignedAPIKeysStep(), opts...)
	}
}

// ByAssignedAPIKeys orders the results by assigned_api_keys terms.
func ByAssignedAPIKeys(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newAssignedAPIKeysStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newAssignedAPIKeysStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(AssignedAPIKeysInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.M2M, true, AssignedAPIKeysTable, AssignedAPIKeysPrimaryKey...),
	)
}
