...
import (
	...
	"github.com/tickernelz/sub2api/ent/migrate"
	...
	"github.com/tickernelz/sub2api/ent/channelmonitordailyrollup"
	...
	"github.com/tickernelz/sub2api/ent/idempotencyrecord"
	...
	"github.com/tickernelz/sub2api/ent/usagecleanuptask"
...
// QueryAssignedGroups queries the assigned_groups edge of a APIKey.
func (c *APIKeyClient) QueryAssignedGroups(_m *APIKey) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(apikey.Table, apikey.FieldID, id),
			sqlgraph.To(group.Table, group.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, apikey.AssignedGroupsTable, apikey.AssignedGroupsPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryAssignedAPIKeys queries the assigned_api_keys edge of a Group.
func (c *GroupClient) QueryAssignedAPIKeys(_m *Group) *APIKeyQuery {
	query := (&APIKeyClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(group.Table, group.FieldID, id),
			sqlgraph.To(apikey.Table, apikey.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, group.AssignedAPIKeysTable, group.AssignedAPIKeysPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
