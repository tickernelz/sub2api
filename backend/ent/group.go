...
type GroupEdges struct {
	...
	// AssignedAPIKeys holds the value of the assigned_api_keys edge.
	AssignedAPIKeys []*APIKey `json:"assigned_api_keys,omitempty"`
...
// AssignedAPIKeysOrErr returns the AssignedAPIKeys value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) AssignedAPIKeysOrErr() ([]*APIKey, error) {
	if e.loadedTypes[6] {
		return e.AssignedAPIKeys, nil
	}
	return nil, &NotLoadedError{edge: "assigned_api_keys"}
}
...
// QueryAssignedAPIKeys queries the "assigned_api_keys" edge of the Group entity.
func (_m *Group) QueryAssignedAPIKeys() *APIKeyQuery {
	return NewGroupClient(_m.config).QueryAssignedAPIKeys(_m)
}
