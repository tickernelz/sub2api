    ...
    <TablePageLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-usage_opencode="{ row }">
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'usage_opencode', label: t('admin.users.columns.usageOpenCode'), sortable: false },
...
const DEFAULT_HIDDEN_COLUMNS = [
  ...
  'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_opencode',
...
const USAGE_COLUMN_KEYS: readonly string[] = ['usage', 'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_opencode']
