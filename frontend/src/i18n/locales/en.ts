export default {
  ...
  keys: {
    ...
    groupLabel: 'Group',
    assignedGroupsLabel: 'Assigned groups',
    assignedGroupsHint: 'Models from all selected groups are available through this key. The default group is used first for billing and routing.',
