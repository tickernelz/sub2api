...
const bedrockPresetMappings = [
  ...
  { label: 'Opus 5.5', from: 'claude-opus-5-5', to: 'us.anthropic.claude-opus-5-5-v1', color: 'bg-pink-100 text-pink-700 hover:bg-pink-200 dark:bg-pink-900/30 dark:text-pink-400' },
